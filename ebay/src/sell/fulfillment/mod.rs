...
pub use self::order::{
  ...
  shipping_fulfillment::{ShippingFulfillment, ShippingFulfillmentPagedCollection, ShippingFulfillmentDetails}
};
...
pub trait FulfillmentApi {
  ...
  fn get_shipping_fulfillments(&self, order_id: &str) -> EbayResult<ShippingFulfillmentPagedCollection>;
  fn get_shipping_fulfillment(&self, order_id: &str, id: &str) -> EbayResult<ShippingFulfillment>;
  fn create_shipping_fulfillment(&self, order_id: &str, details: &ShippingFulfillmentDetails) -> EbayResult<String>;
}
...
impl FulfillmentApi for EbayClient {
  ...
  fn get_shipping_fulfillments(&self, order_id: &str) -> EbayResult<ShippingFulfillmentPagedCollection> {
    self
      .request(Method::Get, &format!("/sell/fulfillment/v1/order/{}/shipping_fulfillment", order_id))?
      .send()?
      .get_response()
  }
  ...
  fn get_shipping_fulfillment(&self, order_id: &str, id: &str) -> EbayResult<ShippingFulfillment> {
    self
      .request(Method::Get, &format!("/sell/fulfillment/v1/order/{}/shipping_fulfillment/{}", order_id, id))?
      .send()?
      .get_response()
  }
  ...
  fn create_shipping_fulfillment(&self, order_id: &str, details: &ShippingFulfillmentDetails) -> EbayResult<String> {
    ...
    let res = self
      .request(Method::Post, &format!("/sell/fulfillment/v1/order/{}/shipping_fulfillment", order_id))?
      .json(details)
      .send()?;
